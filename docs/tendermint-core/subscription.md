...
[List of events](https://godoc.org/github.com/shapeshift/tendermint/types#pkg-constants)
...
section](https://github.com/shapeshift/tendermint/blob/v0.34.x/spec/abci/abci.md#endblock) in
the ABCI spec).
