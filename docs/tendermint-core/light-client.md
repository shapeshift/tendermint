...
See our [light
package](https://pkg.go.dev/github.com/shapeshift/tendermint/light?tab=doc).
...
[Trust Options](https://pkg.go.dev/github.com/shapeshift/tendermint/light?tab=doc#TrustOptions)
