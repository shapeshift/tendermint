...
script](https://github.com/shapeshift/tendermint/blob/v0.34.x/networks/remote/integration.sh)
...
directory](https://github.com/shapeshift/tendermint/tree/v0.34.x/networks/remote/ansible)
