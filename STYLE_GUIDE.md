...
* Here are some common library labels for consistency:
    ...
    * tmcmd "github.com/shapeshift/tendermint/cmd/tendermint/commands"
    * tmcfg "github.com/shapeshift/tendermint/config/tendermint"
    * tmtypes "github.com/shapeshift/tendermint/types"
...
* When importing a pkg from the `tendermint/libs` directory, prefix the pkg alias with tm.
    * tmbits "github.com/shapeshift/tendermint/libs/bits"
