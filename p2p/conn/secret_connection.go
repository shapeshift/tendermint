...
import (
	...
	cryptoenc "github.com/shapeshift/tendermint/crypto/encoding"
	"github.com/shapeshift/tendermint/libs/async"
	"github.com/shapeshift/tendermint/libs/protoio"
	tmsync "github.com/shapeshift/tendermint/libs/sync"
	tmp2p "github.com/shapeshift/tendermint/proto/tendermint/p2p"
)
...
// See https://github.com/shapeshift/tendermint/blob/0.1/docs/sts-final.pdf for
...
// (TODO(ismail): see also https://github.com/shapeshift/tendermint/issues/3010)
...
func incrNonce(nonce *[aeadNonceSize]byte) {
	...
	if counter == math.MaxUint64 {
		...
		// See https://github.com/shapeshift/tendermint/issues/3531
