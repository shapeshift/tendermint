...
Official releases can be found [here](https://github.com/shapeshift/tendermint/releases).
...
- **Where to file issues:** <https://github.com/shapeshift/tendermint/issues>
...
To run a 4-node network, see the `Makefile` in the root of [the repo](https://github.com/shapeshift/tendermint/blob/v0.34.x/Makefile) and run:
...
- Tendermint's license is [Apache 2.0](https://github.com/shapeshift/tendermint/blob/main/LICENSE).

## Contributing

Contributions are most welcome! See the [contributing file](https://github.com/shapeshift/tendermint/blob/main/CONTRIBUTING.md) for more information.
